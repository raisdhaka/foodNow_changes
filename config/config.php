    ...
    'env' => [
        [
            ...
            'fields' => [
                ...
                ['hideon' => 'isloyalty', 'title' => 'Show AI Hub menu', 'key' => 'ENABLE_AI_HUB', 'value' => 'true', 'ftype' => 'bool'],
                ['hideon' => 'isloyalty', 'title' => 'Show Mobile apps menu', 'key' => 'ENABLE_MOBILE_APPS', 'value' => 'true', 'ftype' => 'bool'],
                ...
                ['title' => 'Users can chose the payment provider and later decide if he want to send the order to whatsapp', 'help' => 'When activated, users will first checkout and later decide if they want to send to whatsapp', 'key' => 'DO_REGULAR_CHECKOUT_SOCIAL', 'value' => 'false', 'ftype' => 'bool', 'onlyin' => 'qrsaas', 'hideon' => 'isloyalty,isqrexact,isag,issd'],
                ...
                ['title' => 'Demo video URL', 'help' => 'YouTube video URL or ID for the demo video on landing page. Leave empty to hide the video button.', 'key' => 'DEMO_VIDEO_URL', 'value' => ''],
                ...
                ['title' => 'Link to API documentation', 'help' => 'Link to external API documentation', 'key' => 'EXTERNAL_API_DOCS_URL', 'value' => 'https://mobidonia.gitbook.io/mobile-apps/api'],
                ...
                ['title' => 'Link to privacy policy', 'key' => 'LINK_TO_PR', 'value' => '/blog/Privacy-Policy '],
        ...
        [
            ...
            'fields' => [
                ...
                ['title' => 'Google maps api key for server requests', 'key' => 'GOOGLE_MAPS_API_KEY_SERVER', 'value' => ''],
