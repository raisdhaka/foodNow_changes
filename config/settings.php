...
return [
    ...
    'static_owner_menus' => env('STATIC_OWNER_MENUS', env('APP_CODE_NAME', 'none') === 'rpro'),
    'openai_api_key' => env('OPENAI_API_KEY', ''),
    'external_api_docs_url' => env('EXTERNAL_API_DOCS_URL', 'https://mobidonia.gitbook.io/mobile-apps/api'),
    'app_code_name' => env('APP_CODE_NAME', 'none'),
    'enable_ai_hub' => env('ENABLE_AI_HUB', false),
    'enable_mobile_apps' => env('ENABLE_MOBILE_APPS', false),
