...
Route::prefix('blog')->group(function () {
    Route::get('/', [API\BlogController::class, 'index']);
    Route::get('/{slug}', [API\BlogController::class, 'show']);
});
...
Route::prefix('v2/client')->group(function () {
    ...
    Route::prefix('vendor')->name('vendor.')->group(function () {
        ...
        Route::get('{id}/items_ai', [API\Client\VendorController::class, 'getVendorItemsForAI'])->name('items.ai');
