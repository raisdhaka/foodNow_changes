...
Route::get('/admin/clear/cache', [SettingsController::class, 'clearCache'])->name('admin.clear.cache');
...
Route::middleware('auth', 'impersonate')->group(function () {
    ...
    Route::get('live', [OrderController::class, 'live'])->middleware('isOwnerOnPro')->name('live');
...
Route::get('/page/{slug}', [PagesController::class, 'blog'])->name('blog');
...
// AI Suggestions
Route::get('/ai/suggestions', [CartController::class, 'aiSuggestions'])->name('ai.suggestions');
...
Route::get('/admin/regenerate/sitemap', [SettingsController::class, 'regenerateSitemap'])->name('admin.regenerate.sitemap');
