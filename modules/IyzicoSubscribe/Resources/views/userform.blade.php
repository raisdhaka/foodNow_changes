    ...
    <div class="row justify-content-center">
        <div class="card shadow border-0 mt-8">
            <div class="card-body text-center">
                ...
                <h1 class="mb-4">
                    <span class="badge badge-primary">{{ __('Subscribe to')."  ".$_GET['plan_name'] }}</span>
                </h1>
                ...
                <div class="d-flex justify-content-center">
                    <div class="col-8">
                        ...
                        <div class="font-weight-300 mb-5">
                            {{ __("Thanks for choosing to subscribe.") }}, 
                       </div>
                       <div class="font-weight-300 mb-5">
                ...
                <div class="col-12">
                    ...
                    @endif
                        ...
                        <form method="POST" action="{{ route('iyzicosubscribe.pay') }}">
                            @csrf
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" value="{{$user->email}}" name="email" placeholder="{{ __("Enter your email") }}">
                              </div>
                              <div class="form-group">
                                <label for="idnumber">{{ __("Phone Number:") }}</label>
                                <input type="text" class="form-control" id="idnumber" name="idnumber" placeholder="{{ __("Enter your phone number") }}">
                              </div>
