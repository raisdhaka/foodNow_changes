@extends('layouts.app', ['title' =>  __("Reservation Web Widget creator") ])
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __("Reservation Web Widget creator") }}</h3>
                       ...
                       <div class="card-body">
                            <form action="{{ route('webreswidget.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!-- Header image partials.images -->
                                @include('partials.images',['image'=>['name'=>'logo','label'=>__('Logo'),'value'=>$widget['logo'],'style'=>'width: 200px;']])

                                <!-- Phone number -->
                                @include('partials.input',['class'=>'col-md-12','name'=>"Company Phone number",'id'=>'phone_number','type'=>'text','placeholder'=>"Phone number",'required'=>true, 'value'=>$widget['phone_number']])
                                ...
                                <!-- Widget type -->
                                @include('partials.select',['class'=>'col-md-12','name'=>"Widget type",'id'=>'widget_type','data'=>['1'=>'Submit form','2'=>'Call us'],'required'=>true, 'value'=>$widget['widget_type']])
