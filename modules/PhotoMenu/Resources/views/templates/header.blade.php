        ...
        <div class="flex flex-row packer justify-between items-center w-full h-full row">
            ...
            <div class="flex h-full flex-col text-white justify-center items-start px-6 col-md-6 col-sm-12">
                ...
                <div class="flex items-center space-x-4">
                 ...
                 <a 
                     href='/cart-checkout'
                     class="mt-4 items-center py-2 px-4 text-white leading-none bg-black/40 backdrop-blur-sm rounded-md border-0 cursor-pointer hover:bg-black/60 transition-all duration-300">
