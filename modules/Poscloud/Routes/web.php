...
Route::group([
    ...
    Route::prefix('api/v2/posapi')->group(function() {
        Route::post('/ai-order', 'Main@createAiOrder')->name('poscloud.aiorder');
        Route::get('/ai-orders', 'Main@getAiOrders')->name('poscloud.aiorders.get');

        Route::post('/ai-orders/{id}/process', 'Main@processAiOrder')->name('poscloud.aiorders.process');
    });
});
