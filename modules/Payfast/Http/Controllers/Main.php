...
class Main extends Controller
{
    ...
    public function pay($order)
    {
        ...
        if(config('payfast.useVendor')){
            $merchantId= $vendor->getConfig('payfast_merchantId','');
            $merchantKey= $vendor->getConfig('payfast_merchantKey','');
            $mode= $vendor->getConfig('payfast_mode','');
        }
