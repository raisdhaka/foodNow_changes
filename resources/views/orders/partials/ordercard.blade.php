        ...
        <form method="GET">
            ...
            <div class="tab-content orders-filters">
                    <div class="row">
                        ...
                        <!-- add a hidden select, just as demo -->
                        <div class="col-md-3 d-none">
                            @include('partials.select', ['name'=>"Payment method",'id'=>"payment_method",'placeholder'=>"Select payment method",'data'=>['cash'=>__("Cash"),'stripe'=>__("Stripe"),'paypal'=>__("PayPal")],'required'=>false, 'value'=>''])
                        </div>
