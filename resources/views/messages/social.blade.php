...
@if($order->configs && isset($order->configs['client_name']) && $order->configs['client_name'] !== "")
{{ __('Customer name').": ".$order->configs['client_name'] }}
@endif

@if($order->configs && isset($order->configs['client_phone']) && $order->configs['client_phone'] !== "")
...
@if($order->configs && isset($order->configs['client_phone']) && $order->configs['client_phone'] !== "")
{{ __('Customer phone').": ".$order->configs['client_phone'] }}
@endif
