            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="my-4" />
                        <h6 class="heading-small text-muted mb-4">{{ __('API Token') }}</h6>
                        <div class="pl-lg-4">
                            <div class="d-flex align-items-center">
                                <p class="mb-0 mr-3">{{ auth()->user()->api_token }}</p>
                                <button type="button" class="btn btn-sm btn-primary" onclick="copyToken()">
                                    {{ __('Copy Token') }}
                                </button>
                            </div>
                            <script>
