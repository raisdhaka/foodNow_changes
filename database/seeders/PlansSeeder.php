            ...
            if (config('app.issd')) {
                ...
                if (config('app.isft')) {
                    ...
                    DB::table('plan')->insert([
                        ...
                        'price' => 0,
                        'paddle_id' => '',
                        'description' => 'Perfect for small restaurants looking to digitize their menu with modern QR technology.',
                        'features' => 'Digital QR menu system, Basic menu creation tools, Unlimited customer views, 30 items in the menu, Basic analytics dashboard, Community support',
                        'created_at' => now(),
                        'updated_at' => now(),
                        'enable_ordering' => 2,
                    ]);
                    ...
                    DB::table('plan')->insert([
                        ...
                        'price' => 9,
                        'paddle_id' => '',
                        'description' => 'Elevate your restaurant experience with AI-powered ordering and customer insights.',
                        'features' => 'Advanced QR menu system, Unlimited menu items, 300 AI-powered orders monthly, Basic reservation system, Customer loyalty program, Mobile app ordering, Multiple website design templates, Email & chat support',
                        'created_at' => now(),
                        'updated_at' => now(),
                        'enable_ordering' => 1,
                    ]);
                    ...
                    DB::table('plan')->insert([
                        ...
                        'paddle_id' => '',
                        'period' => 1,
                        'description' => 'The ultimate restaurant management solution with advanced AI features and unlimited growth potential.',
                        'features' => 'Unlimited AI-powered orders, Smart AI menu suggestions, Advanced AI reservation system, Premium mobile app experience, Comprehensive analytics dashboard, Advanced loyalty & rewards program, Custom website designs, Priority dedicated support, Unlimited menu items, Multi-location support',
                        'created_at' => now(),
                        'updated_at' => now(),
                        'enable_ordering' => 1,
                    ]);
