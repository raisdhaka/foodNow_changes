...
class SettingsController extends Controller
{
    ...
    public function clearCache(): RedirectResponse
    {
        try {
            ...
            return redirect()->route('settings.index')->withStatus(__('Cache cleared successfully!'));
        } catch (\Exception $e) {
            return redirect()->route('settings.index')->withStatus(__('Error clearing cache: ') . $e->getMessage());
        }
    }
