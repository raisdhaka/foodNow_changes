...
class RestorantController extends Controller
{
   ...
   protected $webroute_path = 'admin.restaurants.';
   ...
   private function getFilterFields()
   {
    ...
    public function index()
    {
        if (auth()->user()->hasRole('admin')) {
            ...
            $filterFields[] = ['required' => false, 'class' => 'col-md-3 no-select2','classselect' => 'noselecttwo', 'ftype' => 'select', 'name' => 'Plan', 'id' => 'plan', 'placeholder' => 'Select plan', 'data' => Plans::pluck('name', 'id')->toArray()];
     ...
     * @return \Illuminate\Http\Response
     */
    public function index_restorant(Restorant $restaurants)
    {
